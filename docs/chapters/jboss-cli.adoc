...
=== Environment variables (.jbossclirc)

Not persisted

=== Non-interactive mode to set system properties

https://community.jboss.org/wiki/SystemPropertiesInOperationParameterValuesAndCommandArguments
